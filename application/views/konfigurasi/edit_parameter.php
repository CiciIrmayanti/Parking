    ...
    <div class="col-lg-12 col-sm-12 col-12">
        <div class="card">
            ...
            <div class="card" style="height: 500px;">
                <div class="card-header">
                    <h4 class="card-title">Edit nomor polisi</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                    <?php
		...
		?>
                        ...
                        <span>ID Parameter</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"  readonly="readonly" class="form-control" value="<?php echo $data['id_parameter'];?>" name="id_parameter">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                        ...
                        <span>Nama</span>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['nilai'];?>" class="form-control" name="nilai">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['keterangan'];?>" class="form-control" name="keterangan">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
...
$("#FormData").on('submit',(function(e) {
		...
		$.ajax({
        	url:  ' <?php echo base_url('Konfigurasi/simpan_edit_parameter/').$data['id_parameter']; ?>',
			type: "POST",
