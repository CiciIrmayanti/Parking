                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="card" style="height: 500px;">
                                                    <div class="card-header">
                                                        <h4 class="card-title">Tambah Nopol</h4>
                                                    </div>
                                                    <div class="card-content">
                                                        <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="id_nopol" placeholder="Masukkan id nopol">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
            ...
            <?php $this->load->view('include/script') ?>
                <script>
                    $("#FormData").on('submit', (function(e) {
                        ...
                        $.ajax({
                            url: '<?php echo base_url(); ?>Konfigurasi/simpan_nopol',
                            type: "POST",
