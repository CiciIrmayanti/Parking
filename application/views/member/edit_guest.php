                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            <div class="col-md-4">
                                                    <span>ID Guest Periode</span>
                                                </div>
                                            <div class="col-md-8">
                                                <input type="text"  readonly="readonly" class="form-control" value="<?php echo $data['id_guest_periode'];?>" name="id_guest_periode" placeholder="edit id guest periode">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['jenis'];?>" class="form-control" name="jenis" placeholder="Jenis">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['alamat'];?>"  class="form-control" name="alamat" placeholder="Alamat">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['input'];?>"  class="form-control" name="input" placeholder="Input">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['lama'];?>"  class="form-control" name="lama" placeholder="Input">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['petugas'];?>"  class="form-control" name="petugas" placeholder="Alamat">
                                            </div>
                                        </div>
                                    </div>
...
$("#FormData").on('submit',(function(e) {
		...
		$.ajax({
        	url:  ' <?php echo base_url('Member/simpan_edit_guest/').$data['id_guest_periode']; ?>',
			type: "POST",
