        ...
        <div class="card">
            ...
            <div class="card" style="height: 500px;">
                <div class="card-header">
                    <h4 class="card-title">Edit Nopol</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                    <?php
                      foreach($data_nopol as $data){}
                    ?>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"  readonly="readonly" class="form-control" value="<?php echo $data['id_nopol'];?>" name="id_nopol" placeholder="edit nopol">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['nopol'];?>" class="form-control" name="nopol" placeholder="edit nopol">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['informasi'];?>" class="form-control" name="informasi" placeholder="edit informasi">
                                            </div>
                                        </div>
                                    </div>
...
$("#FormData").on('submit',(function(e) {
		...
		$.ajax({
        	url:  ' <?php echo base_url('Konfigurasi/simpan_edit_nopol/').$data['id_nopol']; ?>',
			type: "POST",
