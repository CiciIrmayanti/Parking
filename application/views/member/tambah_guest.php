                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="card" style="height: 700px;">
                                                    <div class="card-header">
                                                        <h4 class="card-title">Tambah Guest Periode</h4>
                                                    </div>
                                                    <div class="card-content">
                                                        <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="id_guest_periode" placeholder="ID Guest Periode">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="nopol" placeholder="Masukan Nomor Polisi">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="input" placeholder="Masukan Input">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="expire" placeholder="Masukan Expire">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
            ...
            <?php $this->load->view('include/script') ?>
                <script>
                    $("#FormData").on('submit', (function(e) {
                        ...
                        $.ajax({
                            url: ' <?php echo base_url(); ?>member/simpan_guest',
                            type: "POST",
