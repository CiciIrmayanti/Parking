    ...
    <div class="col-lg-12 col-sm-12 col-12">
		...
		?>
                        ...
                        <span>No</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"  readonly="readonly" class="form-control" value="<?php echo $data['id_jeniskendaraan'];?>" name="id_jeniskendaraan" placeholder="edit id jenis kendaraan">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                        ...
                        <span>Jenis Kendaraan</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['nama_jeniskendaraan'];?>" class="form-control" name="nama_jeniskendaraan" placeholder="edit nama jenis kendaraan">
                                            </div>
                                        </div>
                                    </div>
                                        </div>
...
$("#FormData").on('submit',(function(e) {
		...
		$.ajax({
        	url:  ' <?php echo base_url('Master_data/simpan_edit_jeniskendaraan/').$data['id_jeniskendaraan']; ?>',
			type: "POST",
