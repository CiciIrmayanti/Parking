              ...
              <div class="col-lg-12 col-sm-12 col-12">
                <div class="card">
                  ...
                  <div class="row">
                        <div >
                        <a href="
                          <?php echo site_url('Master_data/tambah_lokasi') ?>"   class='btn bg-gradient-primary ml-1 mr-1 mb-1' >
                  ...
                  <div class="table-responsive">
                        <table id="DataLokasi" class="table zero-configuration">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>Kode Lokasi</th>
...
var dataTable = $('#DataLokasi').DataTable( {
"processing":true,
"serverSide": true,
"stateSave" : false,
"AutoWidth": true,
...
"ajax":{
url :"<?php echo site_url('master_data/sektorlokasi_json'); ?>",
type: "POST",
error: function(){
$(".my-grid-error").html("");
