            ...
            <div class="row card-title">
              <div class="col-lg-12 col-sm-12 col-12">
                <div class="card">
                  ...
                  <div class="row">
                    <div class="card-header">
                      <h4 class="card-title">Histori Tarif Parkir</h4>
                    </div>
                    </div>
                  </div>
                  ...
                  <div class="table-responsive">
                        <table id="DataProduk" class="table zero-configuration">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>ID Produk</th>
                       ...
                       <div class="table-responsive">
                        <table id="DataPeriode" class="table zero-configuration">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>ID Periode</th>
                              <th>Periode Maksimal</th>
                              <th>Tarif Hilang</th>
                              <th>Tarif Inap</th>
                              <th>Tarif Event</th>
                            </tr>
                      ...
                      <div class="card-header">
                        <h4 class="card-title">Histori Tarif Siang</h4>
                      </div>
                      <div class="table-responsive">
                        <table id="DataTarifSiang" class="table zero-configuration">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>ID Tarif</th>
                      ...
                      <div class="card-header">
                        <h4 class="card-title">Histori Tarif Malam</h4>
                      </div>
                      <div class="table-responsive">
                        <table id="DataTarifMalam" class="table zero-configuration">
                          <thead>
                            <tr>
                              <th>No</th>
                              <th>ID Tarif</th>
...
var dataTable = $('#DataProduk').DataTable( {
"processing":true,
"serverSide": true,
"stateSave" : false,
"AutoWidth": true,
...
"ajax":{
url :"<?php echo site_url('Transaksi/get_data_produk'); ?>",
type: "POST",
error: function(){
$(".my-grid-error").html("");
...
$(document).ready(function() {
var dataTable = $('#DataPeriode').DataTable( {
"processing":true,
"serverSide": true,
"stateSave" : false,
"AutoWidth": true,
...
"aLengthMenu": [[10, 20, 50, 100, 150], [10, 20, 50, 100, 150]],
"ajax":{
url :"<?php echo site_url('Transaksi/get_data_periode'); ?>",
type: "POST",
error: function(){
$(".my-grid-error").html("");
$("#my-grid").append('<tbody class="my-grid-error"><tr><th colspan="12">No data found in the server</th></tr></tbody>');
...
$(document).ready(function() {
var dataTable = $('#DataTarifSiang').DataTable( {
"processing":true,
"serverSide": true,
"stateSave" : false,
"AutoWidth": true,
...
"aLengthMenu": [[10, 20, 50, 100, 150], [10, 20, 50, 100, 150]],
"ajax":{
url :"<?php echo site_url('Transaksi/get_data_siang'); ?>",
type: "POST",
error: function(){
$(".my-grid-error").html("");
$("#my-grid").append('<tbody class="my-grid-error"><tr><th colspan="12">No data found in the server</th></tr></tbody>');
...
$(document).ready(function() {
var dataTable = $('#DataTarifMalam').DataTable( {
"processing":true,
"serverSide": true,
"stateSave" : false,
"AutoWidth": true,
...
"aLengthMenu": [[10, 20, 50, 100, 150], [10, 20, 50, 100, 150]],
"ajax":{
url :"<?php echo site_url('Transaksi/get_data_malam'); ?>",
type: "POST",
error: function(){
$(".my-grid-error").html("");
$("#my-grid").append('<tbody class="my-grid-error"><tr><th colspan="12">No data found in the server</th></tr></tbody>');
