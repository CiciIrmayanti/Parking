                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"  readonly="readonly" class="form-control" value="<?php echo $data['id_user'];?>" name="id_user" placeholder="edit id user">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['username'];?>" class="form-control" name="username" placeholder="edit username">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['nama'];?>" class="form-control" name="nama" placeholder="edit nama">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <option value="<?php echo $data['id_level'];?>"><?php echo $data['nama_jabatan'];?></option>
                                                <?php foreach ($level as $level) { ?>
                                                  <option value="<?php echo $level['id_level'];?>"><?php echo $level['nama_jabatan'];?></option>
                                               <?php } ?>
                                                </select>
                                            </div>
                                        </div>
...
$("#FormData").on('submit',(function(e) {
		...
		$.ajax({
        	url:  ' <?php echo base_url('Konfigurasi/simpan_edit_akses/').$data['id_user']; ?>',
			type: "POST",
