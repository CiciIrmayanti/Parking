                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="card" style="height: 500px;">
                                                    <div class="card-header">
                                                        <h4 class="card-title">Tambah Produk Parkir</h4>
                                                    </div>
                                                    <div class="card-content">
                                                        <div class="card-body">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="kode_produk" placeholder="Masukkan kode produk" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="jenis_kendaraan" placeholder="Masukkan jenis kendaraan" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
            ...
            <?php $this->load->view('include/script') ?>
                <script>
                    $("#FormData").on('submit', (function(e) {
                        ...
                        $.ajax({
                            url: ' <?php echo base_url(); ?>Master_data/simpan_produkparkir',
                            type: "POST",
