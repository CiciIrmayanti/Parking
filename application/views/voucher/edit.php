  ...
  <div class="row">
    ...
    ?>
                        ...
                        <span>ID Voucher</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"  readonly="readonly" class="form-control" value="<?php echo $data['id_voucher'];?>" name="id_voucher" placeholder="edit id voucher">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                        ...
                        <span>Nominal</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['nominal'];?>" class="form-control" name="nominal">
                                            </div>
                                        </div>
                                    </div>
...
$("#FormData").on('submit',(function(e) {
    ...
    $.ajax({
          url:  ' <?php echo base_url('Voucher/simpan_edit_voucher/').$data['id_voucher']; ?>',
      type: "POST",
