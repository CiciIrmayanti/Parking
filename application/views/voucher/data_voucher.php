...
<div class="row" >
  &nbsp; &nbsp; &nbsp; <div >
   <a href="<?php echo site_url('anggota/excel') ?>" class='btn btn-success'><i class='fa fa-file-excel fa-fw'></i>Excel</a>
   </div>
   <div >
   <a href="<?php echo site_url('anggota/cetak') ?>" target="_blank" class='btn btn-danger' ><i class='fa fa-file-pdf fa-fw'></i>PDF</a>
   </div>
   <div >
   <a href="<?php echo site_url('voucher/tambah') ?>"   class='btn btn-primary' ><i class='fa fa-plus fa-fw'></i>ADD</a>							
   </div>							
   </div>
...
<th>Kode</th>
<th>Mulai Aktif</th>
<th class='no-sort'>Tidak Aktif</th>
<th class='no-sort'>Petugas</th>
<th></th>
<th></th>
                                    </tr>
                                </thead>
