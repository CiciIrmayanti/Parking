            ...
            <div class="content-body">
              ...
              <div class="row">
                <div class="col-4">
                        ...
                        <h5>Masuk</h5>
                   <img src="https://192.168.8.106:8080/video" width="100%" height="230px">
                          ...
                          <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="first-name-vertical" class="form-control form-control-lg" name="fname" placeholder="Kode Parking">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                        <div class="form-group">
             ...
             <div class="row">
                 <div class="col-4">
                    <h5>Keluar</h5>
                  <!--   <img width="100%" src="https://mmc.tirto.id/image/otf/500x0/2017/12/06/antarafoto-rencana-naikkan-tarif-parkir-051217-adm-1_7174_ratio-16x9.jpg"> -->
                 <img src="http://190.190.190.199/doc/page/preview.asp" width="100%" height="230px">
