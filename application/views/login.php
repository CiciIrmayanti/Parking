...
<head>
    ...
    <title>IZZI PARKING</title>
    <link rel="apple-touch-icon" href="<?php echo base_url() ?>app-assets/images/ico/apple-icon-120.png">
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url() ?>app-assets/images/ico/izzi parking.png">
                                    ...
                                    <div class="card rounded-0 mb-0 px-2">
                                        <div class="card-header pb-1">
                                            <div class="card-title">
                                                <h4 class="mb-0"><img src="<?php echo base_url() ?>app-assets/images/pages/login.png" alt="branding logo"></h4>
                                            </div>
                                        </div>
                                            ...
                                            <div class="card-body pt-1">
                                                <form id="loginForm" action="<?php echo base_url('secure/check_login'); ?>" data-toggle="validator" method="POST">
                                                    ...
                                                    <fieldset class="form-label-group position-relative has-icon-left">
                                                     ...
                                                     <button type="reset" class="btn btn-outline-danger float-left btn-inline">Cancel</button>
                                                    <button style="width: 45%" type="submit" class="btn btn-success float-right btn-inline">Sign in <i class="fa fa-arrow-right"></i></button>
                                                </form>
                                            </div>
                                        </div>
