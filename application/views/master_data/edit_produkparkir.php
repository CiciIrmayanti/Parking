        ...
        <div class="card">
            ...
            <div class="card" style="height: 500px;">
                <div class="card-header">
                    <h4 class="card-title">Edit Produk Parkir</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                    <?php
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"  readonly="readonly" class="form-control" value="<?php echo $data['id_produk'];?>" name="id_produk" placeholder="edit id produk">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['kodeproduk'];?>" class="form-control" name="kode_produk" placeholder="edit kode produk">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['namaproduk'];?>" class="form-control" name="nama_produk" placeholder="edit nama produk">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['jeniskendaraan'];?>" class="form-control" name="jenis_kendaraan" placeholder="edit jenis kendaraan">
                                            </div>
                                        </div>
                                    </div>
...
$("#FormData").on('submit',(function(e) {
		...
		$.ajax({
        	url:  ' <?php echo base_url('Master_data/simpan_edit_produkparkir/').$data['id_produk']; ?>',
			type: "POST",
