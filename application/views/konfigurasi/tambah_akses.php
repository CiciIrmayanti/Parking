                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="id_level" placeholder="Masukkan id level">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                        ...
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="foto_profil" placeholder="Masukkan foto profil">
                                                                                </div>
                                                                            </div>
                                                                        </div>
            ...
            <?php $this->load->view('include/script') ?>
                <script>
                    $("#FormData").on('submit', (function(e) {
                        ...
                        $.ajax({
                            url: ' <?php echo base_url(); ?>Konfigurasi/simpan_akses',
                            type: "POST",
