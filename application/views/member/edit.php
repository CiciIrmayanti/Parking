    ...
    <div class="col-lg-12 col-sm-12 col-12">
		...
		?>
                        ...
                        <span>ID Member</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"  readonly="readonly" class="form-control" value="<?php echo $data['id_member'];?>" name="id_member" placeholder="First Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                        ...
                        <span>Username</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['name'];?>" class="form-control" name="name" placeholder="Email">
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <span>Tanggal lahir</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="date" value="<?php echo $data['tanggal_lahir'];?>"  class="form-control" name="tanggal_lahir" placeholder="Mobile">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                        ...
                        <span>Alamat</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['alamat'];?>"  class="form-control" name="alamat" placeholder="Password">
                                            </div>
                                        </div>
                                    </div>
                                     <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="date" class="form-control" name="aktif_mulai" placeholder="Aktif Mulai">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="date" class="form-control" name="aktif_selesai" placeholder="Selesai aktif">
                                                                                </div>
                                                                            </div>
                                                                        </div>
...
$("#FormData").on('submit',(function(e) {
		...
		$.ajax({
        	url:  ' <?php echo base_url(); ?>member/simpan_edit',
			type: "POST",
