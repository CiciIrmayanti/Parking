              ...
              <div class="col-lg-12 col-sm-12 col-12">
                <div class="card">
                  ...
                  <div class="row">
                        <div >
                        <a href="
                          <?php echo site_url('Master_data/tambah_jeniskendaraan') ?>"   class='btn bg-gradient-primary ml-1 mr-1 mb-1' >
...
"ajax":{
url :"<?php echo site_url('master_data/get_data_jeniskendaraan'); ?>",
type: "POST",
error: function(){
$(".my-grid-error").html("");
...
$(document).on('click', '#TambahJenisKendaraan, #edit, #detail', function(e){
e.preventDefault();

if($(this).attr('id') == 'TambahJenisKendaraan')
{
...
var Pass = 0;
$('#TabelTambahJenisKendaraan tbody tr').each(function(){
...
$('#SimpanTambahJenisKendaraan').addClass('disabled');
}
else
{
$(this).parent().find('span').html('');
$('#SimpanTambahJenisKendaraan').removeClass('disabled');
...
if(json.status == 0){
 $('#TabelTambahJenisKendaraan tbody tr:eq('+Indexnya+') td:nth-child(2)').find('span').html(json.pesan);
 $('#SimpanTambahJenisKendaraan').addClass('disabled');
}
if(json.status == 1){
 $('#SimpanTambahJenisKendaraan').removeClass('disabled');
