    ...
    <div class="col-lg-12 col-sm-12 col-12">
		...
		?>
                        ...
                        <span>No</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text"  readonly="readonly" class="form-control" value="<?php echo $data['id_sektorlokasi'];?>" name="id_sektorlokasi" placeholder="edit id lokasi">
                                            </div>
                                        </div></div>
                        ...
                        <span>Kode</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['kode'];?>" class="form-control" name="kode" placeholder="edit kode">
                                            </div>
                                        </div>
                        ...
                        <span>Keterangan</span>
                                            ...
                                            <div class="col-md-8">
                                                <input type="text" value="<?php echo $data['keterangan'];?>" class="form-control" name="keterangan" placeholder="edit keterangan">
                                            </div>
                                        </div>
                                    </div>
                                    </div>
...
$("#FormData").on('submit',(function(e) {
		...
		$.ajax({
        	url:  ' <?php echo base_url('Konfigurasi/simpan_edit_lokasi/').$data['id_sektorlokasi']; ?>',
			type: "POST",
