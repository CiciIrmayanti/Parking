                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="kode_lokasi" placeholder="Masukkan kode lokasi" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="keterangan" placeholder="Masukan keterangan lokasi" required>
                                                                                </div>
                                                                            </div>
                                                                        </div>
            ...
            <?php $this->load->view('include/script') ?>
                <script>
                    $("#FormData").on('submit', (function(e) {
                        ...
                        $.ajax({
                            url: ' <?php echo base_url(); ?>Master_data/simpan_lokasi',
                            type: "POST",
