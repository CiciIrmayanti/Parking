                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="id_parameter" placeholder="Masukkan ID Parameter">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
                                                                            <div class="form-group row">
                                                                                ...
                                                                                <div class="col-md-8">
                                                                                    <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Panjang">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-12">
            ...
            <?php $this->load->view('include/script') ?>
                <script>
                    $("#FormData").on('submit', (function(e) {
                        ...
                        $.ajax({
                            url: ' <?php echo base_url(); ?>Konfigurasi/simpan',
                            type: "POST",
